        ...
        <div className="p-6 overflow-y-auto space-y-5">
          ...
          <div className="bg-[#FAF8F5] border border-[#E2D9CF] rounded-2xl p-4 space-y-2 text-xs">
            ...
            <div className="flex justify-between text-[#8A7E74]">
              ...
              <span className="font-semibold text-green-700">Secured in Escrow</span>
            </div>
            <div className="flex justify-between text-[#8A7E74]">
              <span>Hourly Care Rate</span>
              <span className="font-semibold text-[#1C1A17]">3,500 XAF / hr</span>
            </div>
            <div className="pt-2 border-t border-[#E2D9CF] flex justify-between font-bold text-sm text-[#1E4030]">
              <span>Total Escrow Amount</span>
              <span>11,000 XAF</span>
            </div>
          </div>
                    ...
                    {showDropdown && (
                      <div className="absolute right-0 top-10 w-40 bg-white border border-[#E2D9CF] rounded-xl shadow-xl py-1.5 z-50 animate-fadeIn">
                        ...
                        <button
                          ...
                          className="w-full px-4 py-2 text-xs text-[#1E4030] hover:bg-[#EDF7F2] text-left font-semibold transition-colors cursor-pointer"
                        >
                          Get OTP
                        </button>
                      </div>
