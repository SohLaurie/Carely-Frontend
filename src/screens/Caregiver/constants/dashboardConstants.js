export const CAREGIVER_CONSTANTS = {
  ...
  DEFAULT_CAREGIVER_NAME: 'Marie-Claire',
  DEFAULT_FULL_NAME: 'Marie-Claire Nkomo',
  DEFAULT_AVATAR: 'https://images.unsplash.com/photo-1627328543975-3f0ba8a823b0?w=400&h=400&fit=crop&auto=format'
};
