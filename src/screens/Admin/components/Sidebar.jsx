...
export default function Sidebar({
  ...
  return (
    <>
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#11231A] text-white flex flex-col justify-between transition-transform duration-300 lg:static lg:translate-x-0 ${
